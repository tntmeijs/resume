...
\vspace{-9pt}
\begin{itemize}
  \item Designed and built components for a serverless (Go / AWS) digital onboarding flow for a large Dutch bank by creating new (micro)services, integrating with existing systems, and designing the application's architecture.
